            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>{$row['enrollment date']}</td>
                        <td>{$row['progress']}</td>
                        <td>
                            <a href='updateenrollment.php?enrollment id={$row['enrollment id']}'  class='btn btn-info'><i class='fas fa-edit'></i></a>
                            <a href='deleteenrollment .php?enrollment id={$row['enrollment id']}' class='btn btn-danger'><i class='fas fa-trash'></i></a>
                        </td>
                    </tr>
                    ";
                }
