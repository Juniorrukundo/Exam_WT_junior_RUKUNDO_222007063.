...
<body>
    <div class="container mt-5">
        ...
        <h4 class="text-center text-primary mb-4">THIS IS  REPORT ABOUT instructor</h4>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>{$row['rating']}</td>
                        <td>
                            <a href='updateinstructor.php?instructor id={$row['instructor id']}'  class='btn btn-info'><i class='fas fa-edit'></i></a>
                            <a href='deleteinstructor .php?instructor id={$row['instructor id']}' class='btn btn-danger'><i class='fas fa-trash'></i></a>
                        </td>
                    </tr>
                    ";
                }
