            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>{$row['feedback']}</td>
                        <td>
                            <a href='updatesubmission.php?submission id={$row['submission id']}'  class='btn btn-info'><i class='fas fa-edit'></i></a>
                            <a href='deletesubmission.php?submission id={$row['submission id']}' class='btn btn-danger'><i class='fas fa-trash'></i></a>
                        </td>
                    </tr>
                    ";
                }
